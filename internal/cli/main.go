...
func Main(version string) {
	...
	pathPtr := flag.String("path", defaultDirectory, "")
...
Database drivers: `+strings.Join(database.List(), ", ")+"\n", createUsage, gotoUsage, upUsage, downUsage, dropUsage, forceUsage)
	...
	case "create":
		...
		extPtr := createFlagSet.String("ext", defaultExtension, "File extension")
		dirPtr := createFlagSet.String("dir", defaultDirectory, "Directory to place file in (default: current working directory)")
